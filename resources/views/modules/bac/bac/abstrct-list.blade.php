              ...
              <div class="box-body">
               ...
               <div class="form-group">
                     <label for="obr_no" class="col-sm-2 control-label">OBR NO.</label>
                      <div class="col-sm-6">
                        <input type="text"    class="form-control"   id="obr_no" name="obr_no"  placeholder="OBR NO." disabled="true" />
                    </div>
                     <label for="obr_date" class="col-sm-2 control-label">OBR DATE : </label>
                        <div class="col-sm-2">
                        <input type="text" class="form-control" id="obr_date" name="obr_date" placeholder="OBR DATE" disabled="true" />
                    </div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label for="bac_control_no" class="col-sm-2 control-label">BAC CONTROL NO : </label>
                  <div class="col-sm-5">
