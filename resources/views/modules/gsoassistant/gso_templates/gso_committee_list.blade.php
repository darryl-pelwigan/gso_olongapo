...
$('.committee').click(function(){
  ...
  $.ajax({
            type: "POST",
             url: "{{route('gso.rm-bac-committee')}}",
            data : {
                    committee_id:id,
                    _token : '{{csrf_token()}}'
                  },
...
$('.attested_by').click(function(){
  ...
  $.ajax({
            type: "POST",
             url: "{{route('gso.rm-bac-attested_by')}}",
             data : {
                    attested_by:id,
                    _token : '{{csrf_token()}}'
                  },
...
$('.approved_by').click(function(){
  ...
  $.ajax({
            type: "POST",
             url: "{{route('gso.rm-bac-approved_by')}}",
            data : {
                    approved_by:id,
                    _token : '{{csrf_token()}}'
                  },
...
$.fn.senBacCommittee = function(){
    var datax = $('#senBacCommittee').serialize();
     $.ajax({
            type: "POST",
             url: "{{route('gso.set-bac-committee')}}",
            data : datax,
            dataType: "json",
            error: function(){
              console.log('error');
...
$('#employee_name').autocomplete({
        serviceUrl: '{{route("gso.get_employee_name")}}',
        dataType: 'json',
        type: 'POST',
        params : {
                  _token : '{{csrf_token()}}'
...
$('#employee_position').autocomplete({
        serviceUrl: '{{route("gso.a_get_position")}}',
        dataType: 'json',
        type: 'POST',
        params : {
                  _token : '{{csrf_token()}}'
