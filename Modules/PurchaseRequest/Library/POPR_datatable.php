             ...
             foreach($PurchaseNo as $pr) {
                ...
                if(count($approval) > 0){
                     $record = array(
                          ...
                          'olongapo_purchase_request_no.designated_req' =>  $pr->designated_req ? $pr->designated_req : ' ',
                          'olongapo_purchase_request_no.name_avail' =>  $pr->name_avail ? $pr->name_avail : ' ',
                          'olongapo_purchase_request_no.designation_avail' =>  $pr->designation_avail ? $pr->designation_avail : ' ',
                          'olongapo_purchase_request_no.name_app' =>  $pr->name_app ? $pr->name_app : ' ',
                          'olongapo_purchase_request_no.designation_app' =>  $pr->designation_app ? $pr->designation_app : ' ',
                          'dept_id' => $pr->dept_id,
