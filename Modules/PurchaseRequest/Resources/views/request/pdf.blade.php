           ...
           <div class="box-body">
            ...
            <div class="pages">
             <header>
              ...
              <table class="table table-bordered" id="tbl_items" width="100%" style="border-collapse:collapse; font-size:15px">
                    <thead>
                      <tr>
              ...
              @endif
              <table class="table  table-bordered table_footer" border="1" style="border-collapse: collapse;">
                  <tr>
                      <td width="50%">&nbsp;</td>
