...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
          GSO Template Settings

      </h1>
       <label>Enclosed within brackets [] are shortcodes</label>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <h3 class="box-title">EDIT GSO TEMPLATE</h3>
              <button class="btn btn-sm btn-primary pull-right"> VIEW SHORTCODES</button>
            <!-- /.box-header -->
            <form class="form-horizontal" method="POST" action="{{route('gso.gso_template')}}">
            {{csrf_field()}}
            <div class="box-body">
            ...
            <div class="col-md-10 col-md-offset-1">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="tmpl_desc" name="tmpl_desc" placeholder="Enter Description" value="{{$gsotemp->template_desc}}">
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="tmpl_code" name="tmpl_code" placeholder="Enter Code" value="{{ ($gsotemp->code) }}">
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                   <textarea id="template_html" name="tmpl_tmpl" placeholder="Enter Your Template Content Here....">{{ json_decode($gsotemp->template, true) }}</textarea>
                  </div>
                  </div>
            </div>
            </div>
