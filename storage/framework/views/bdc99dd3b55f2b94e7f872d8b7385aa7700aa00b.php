        ...
        <div class="box">
          ...
          <div class="">
            <?php for( $x = 0 ; $x< count($committee) ; $x++): ?>
                <div class="col-md-4">
                    <h3><strong><?php echo e($committee[$x]->employee_name); ?></strong></h3>
                    <h4><?php echo e($committee[$x]->title); ?></h4>
					<button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#deleteGroup_modal<?php echo e($committee[$x]->comm_id); ?>" title="DELETE">Delete</button>
                    <!-- Modal-->
                    <div class="modal fade" id="deleteGroup_modal<?php echo e($committee[$x]->comm_id); ?>" role="dialog">
                             <div class="modal-dialog">
                                    ...
                                    <div class="modal-footer">
                                            <button class="btn btn-danger committee" data-committee="<?php echo e($committee[$x]->comm_id); ?>">Delete</button>
                                    </div>
                                    </div>
                                     <!-- /.Modal content-->
                            </div>
          ...
          <div class="">
            <?php for( $x = 0 ; $x< count($approved_by) ; $x++): ?>
                <div class="col-md-4">
                    <h3><strong><?php echo e($approved_by[$x]->employee_name); ?></strong></h3>
                    <h4><?php echo e($approved_by[$x]->title); ?></h4>
                    <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#deleteGroup_modal<?php echo e($approved_by[$x]->comm_id); ?>" title="DELETE">Delete</button>
                    <!-- Modal-->
                    <div class="modal fade" id="deleteGroup_modal<?php echo e($approved_by[$x]->comm_id); ?>" role="dialog">
                             <div class="modal-dialog">
                                    <!-- Modal content-->
                                    <div class="modal-content">
                                            <div class="modal-header">
                                    ...
                                    <div class="modal-footer">
                                            <button class="btn btn-danger approved_by" data-approved_by="<?php echo e($approved_by[$x]->comm_id); ?>">Delete</button>
                                    </div>
                                    </div>
                                     <!-- /.Modal content-->
                            </div>
          ...
          <div class="">
            <?php for( $x = 0 ; $x< count($attested_by) ; $x++): ?>
                <div class="col-md-4">
                    <h3><strong><?php echo e($attested_by[$x]->employee_name); ?></strong></h3>
                    <h4><?php echo e($attested_by[$x]->title); ?></h4>
                    
                   <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#deleteGroup_modal<?php echo e($attested_by[$x]->comm_id); ?>" title="DELETE">Delete</button>
                    <!-- Modal-->
                    <div class="modal fade" id="deleteGroup_modal<?php echo e($attested_by[$x]->comm_id); ?>" role="dialog">
                             <div class="modal-dialog">
                                    <!-- Modal content-->
                                    <div class="modal-content">
                                            <div class="modal-header">
                                    ...
                                    <div class="modal-footer">
                                            <button class="btn btn-danger attested_by" data-attested_by="<?php echo e($attested_by[$x]->comm_id); ?>">Delete</button>
                                    </div>
                                    </div>
                                     <!-- /.Modal content-->
                            </div>
      ...
      <div id="status"></div>
        <div id="contents-menu">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                        <input type="text" name="employee_position" id="employee_position" required class="form-control" />
...
$('.committee').click(function(){
  ...
  $.ajax({
            type: "POST",
             url: "<?php echo e(route('gso.rm-bac-committee')); ?>",
            data : {
                    committee_id:id,
...
$('.attested_by').click(function(){
  ...
  $.ajax({
            type: "POST",
             url: "<?php echo e(route('gso.rm-bac-attested_by')); ?>",
             data : {
                    attested_by:id,
                    _token : '<?php echo e(csrf_token()); ?>'
                  },
...
$('.approved_by').click(function(){
  ...
  $.ajax({
            type: "POST",
             url: "<?php echo e(route('gso.rm-bac-approved_by')); ?>",
            data : {
                    approved_by:id,
                    _token : '<?php echo e(csrf_token()); ?>'
                  },
...
$.fn.senBacCommittee = function(){
    var datax = $('#senBacCommittee').serialize();
     $.ajax({
            type: "POST",
             url: "<?php echo e(route('gso.set-bac-committee')); ?>",
            data : datax,
            dataType: "json",
            error: function(){
              console.log('error');
...
$('#employee_name').autocomplete({
        serviceUrl: '<?php echo e(route("gso.get_employee_name")); ?>',
        dataType: 'json',
        type: 'POST',
        params : {
                  _token : '<?php echo e(csrf_token()); ?>'
...
$('#employee_position').autocomplete({
        serviceUrl: '<?php echo e(route("gso.a_get_position")); ?>',
        dataType: 'json',
        type: 'POST',
        params : {
                  _token : '<?php echo e(csrf_token()); ?>'
