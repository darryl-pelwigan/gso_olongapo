             ...
             { data: 'obr_date', name: 'olongapo_obr.obr_date' },
              ...
              render : function(data , type , row){
                      if(data.acceptance_id){
                        ...
                        <form method="post" action="<?php echo e(route('po.po_acceptance_pdf')); ?>"><?php echo e(csrf_field()); ?><input type="hidden" name="acceptance_id" value="'+data.acceptance_id+'" /><input type="submit" class="btn btn-sm btn-default" name="pdf" value="Pdf" /> </form>  ';
                      }else{
...
// });
  ...
  $.fn.sentRequisitionNo = function(){
      ...
      $.ajax({
            type: "POST",
            url: "<?php echo e(route('po.add_acceptance')); ?>",
