            ...
            <?php for( $x = 0 ; $x< count($committee) ; $x++): ?>
                <div class="col-md-4">
                    ...
                    <h4><?php echo e($committee[$x]->title); ?></h4>
                      <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#deleteGroup_modala<?php echo e($committee[$x]->comm_id); ?>" title="DELETE">Delete</button>
                      <!-- Modal-->
                    <div class="modal fade" id="deleteGroup_modala<?php echo e($committee[$x]->comm_id); ?>" role="dialog">
          ...
          <div class="">
            <?php for( $x = 0 ; $x< count($approved_by) ; $x++): ?>
                <div class="col-md-4">
                    ...
                    <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#deleteGroup_modalb<?php echo e($approved_by[$x]->comm_id); ?>" title="DELETE">Delete</button>
                    <!-- Modal-->
                    <div class="modal fade" id="deleteGroup_modalb<?php echo e($approved_by[$x]->comm_id); ?>" role="dialog">
                             <div class="modal-dialog">
                                    <!-- Modal content-->
                                    <div class="modal-content">
                                            <div class="modal-header">
          ...
          <div class="">
            <?php for( $x = 0 ; $x< count($attested_by) ; $x++): ?>
                <div class="col-md-4">
                    ...
                    <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#deleteGroup_modalc<?php echo e($attested_by[$x]->comm_id); ?>" title="DELETE">Delete</button>
                    <!-- Modal-->
                    <div class="modal fade" id="deleteGroup_modalc<?php echo e($attested_by[$x]->comm_id); ?>" role="dialog">
                             <div class="modal-dialog">
                                    <!-- Modal content-->
                                    <div class="modal-content">
                                            <div class="modal-header">
...
$('.committee').click(function(){
  ...
  $.ajax({
            type: "POST",
             url: "<?php echo e(route('bac.rm-bac-committee')); ?>",
            data : {
                    committee_id:id,
...
$('.attested_by').click(function(){
  ...
  $.ajax({
            type: "POST",
             url: "<?php echo e(route('bac.rm-bac-attested_by')); ?>",
             data : {
                    attested_by:id,
                    _token : '<?php echo e(csrf_token()); ?>'
                  },
...
$('.approved_by').click(function(){
  ...
  $.ajax({
            type: "POST",
             url: "<?php echo e(route('bac.rm-bac-approved_by')); ?>",
            data : {
                    approved_by:id,
                    _token : '<?php echo e(csrf_token()); ?>'
                  },
...
$.fn.senBacCommittee = function(){
    var datax = $('#senBacCommittee').serialize();
     $.ajax({
            type: "POST",
             url: "<?php echo e(route('bac.set-bac-committee')); ?>",
            data : datax,
            dataType: "json",
            error: function(){
              console.log('error');
...
$('#employee_name').autocomplete({
        serviceUrl: '<?php echo e(route("bac.get_employee_name")); ?>',
        dataType: 'json',
        type: 'POST',
        params : {
                  _token : '<?php echo e(csrf_token()); ?>'
...
$('#employee_position').autocomplete({
        serviceUrl: '<?php echo e(route("bac.a_get_position")); ?>',
        dataType: 'json',
        type: 'POST',
        params : {
                  _token : '<?php echo e(csrf_token()); ?>'
