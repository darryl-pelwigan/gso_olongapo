    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="contents-menu">
         <div class="box-body">
            <form class="form-horizontal" method="POST" id="view_bac" action="<?php echo e(route('bac.view_bac_cn')); ?>" target="_blank">

              <div class="form-group">
                  <label for="obr_date" class="col-sm-3 control-label">Template : </label>
                  <div class="col-sm-9">
                      <select class="form-control" name="bac_template" >
                        <?php for($x = 0; $x < count($templatex); $x++ ): ?>
                              <option value="<?php echo e($templatex[$x]->id); ?>"><?php echo e(( $templatex[$x]->template_desc.' - '.$templatex[$x]->code )); ?></option>
                        <?php endfor; ?>
                      </select>
                  </div>
                </div>
