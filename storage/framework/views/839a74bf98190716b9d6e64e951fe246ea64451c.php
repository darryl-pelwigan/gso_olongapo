      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <form class="form-horizontal" method="POST" action="<?php echo e(route('gso.proc_methods_save')); ?>">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div id="contents-menu">
                  <form class="form-horizontal" id="proc_method" method="post" action="<?php echo e(route('gso.proc_methods_update')); ?>">
                    <div class="box-body">
                      <div id="statusCI"></div>
                      <div class="form-group">
  ...
  $(function() {
    ...
    $.fn.deleteMethod = function (id) {
      $.ajax({
        ...
        dataType: 'JSON',
        url: '<?php echo e(route("gso_proc_methods_delete")); ?>',
    ...
    $.fn.method_update = function(id) {
      $.ajax({
        ...
        dataType: 'JSON',
        url: '<?php echo e(route("gso.proc_methods_get")); ?>',
        success: function(data) {
