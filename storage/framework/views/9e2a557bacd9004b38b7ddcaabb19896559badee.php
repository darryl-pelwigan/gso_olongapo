          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">BAC TEMPLATE List</h3>
               ...
               <a href="<?php echo e(route('bac.add_template')); ?>" class="pull-right btn btn-success btn-sm"><i class="fa fa-plus"></i></a>&nbsp; &nbsp;&nbsp; &nbsp;
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
$(function() {
       $('#purchase_order_list').dataTable({
        ...
        ajax:{
          ...
          data : {
                  dataTables : 'bac_templates',
                  "_token" : '<?php echo e(csrf_token()); ?>'
          }
        },
        columns: [
            { data: null , name: 'olongapo_bac_template.id' ,
              render: function (data, type, row, meta) {
                  return meta.row + meta.settings._iDisplayStart + 1;
              }
            },
            { data: 'templ_desc' , name: 'olongapo_bac_template.template_desc' },
            { data: 'templ_date' , name: 'olongapo_bac_template.updated_at' },
            { data: null , name: 'olongapo_bac_template.id' ,
              render: function (data, type, row, meta) {
                  return '<a href="<?php echo e(route('bac.view_template',[ 'id'=>'' ])); ?>/'+data.templ_id+'" class="btn btn-info btn-xs" >view</a>';
              }
            }
        ],
        columnDefs: [
...
//Date picker
  ...
  $.fn.processBac = function(prno_id){
    $.ajax({
            type: "POST",
             url: "<?php echo e(route('pr.get-request')); ?>",
            data : {
              prno_id : prno_id,
              _token : '<?php echo e(csrf_token()); ?>'
            },
