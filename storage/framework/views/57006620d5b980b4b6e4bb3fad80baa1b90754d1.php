  ...
  <div class="main-border content-wrapper">
    ...
    <section class="content">
        <table width="100%">
          ...
          <tr>
              <td class="text_center"><img src="<?php echo e(asset('olongapo')); ?>/img/logo-100.png" alt="" height="25px;"></td>
          </tr>
          <tr>
            ...
            <td width="30%" class="border padding_top_bottom font_size_11">
              <table width="100%">
                <tr>
                  ...
                  <td class="text_center border_bottom" width="90%"><?php echo e($info->_main_dept_desc); ?></td>
                </tr>
                <tr>
                  <td>Office:</td>
            ...
            <td class="border" width="50%">
              <table width="100%">
                <tr>
                  ...
                  <td class="border_bottom text_center" width="40%"><?php echo e($info->ris_no); ?></td>
                  <td class="text_center" width="15%">Date:</td>
                  <td class="border_bottom text_center" width="25%"><?php echo e(date('F j Y', strtotime($info->ris_date))); ?><</td>
                </tr>
                <tr>
                  <td class="text_center">SAI No.:</td>
                  <td class="border_bottom text_center"><?php echo e($info->sai_no ?? ''); ?></td>
                  <td class="text_center" width="15%">Date:</td>
                  <td class="border_bottom text_center"><?php echo e(isset($info->sai_date) ?  date('F j Y', strtotime($info->sai_date )) : ''); ?></td>
                </tr>
              </table>
            </td>
          </tr>
       ...
       <div >
                  <table class="table1 table-bordered page-break" width="100%">
                      ...
                      <?php $count=1; $total_price=0; ?>
                        <?php $__currentLoopData = $po_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="tbl_items">
                              <td style="text-align: center;"><?php echo e($count); ?></td>
                              <td style="text-align: center; font-size: 11px; padding: 0 5px;" ><?php echo e($data->unit); ?>  </td>
                            <?php
                                ...
                                ?>
                              <td style="text-align: right; padding-right: 5px;"><?php echo e($data->qty); ?> </td>
                        ...
                        ?>
                            <tr>
                             ...
                             <td class="text-right2 total" style="font-size: 12px;"><?php echo e(number_format($total_price,2)); ?></td>
                            </tr>
                            <tr>
                              <td colspan="6">
                                <table class="table_header" width="100%">
                                  <tr>
                                    ...
                                    <td width="90%" class="underline" style="margin-right: 5px;"><?php echo e($info->pr_purpose ?? ''); ?></td>
                                    <td width="0.5%"></td>
                                  </tr>
                                  <tr>
                              ...
                              <td colspan="6">
                                <table class="table1 page-break" width="100%">
                                  ...
                                  <tr>
                                    ...
                                    <td class="border" align="center" style="font-size: 9px;"> <?php echo e(strtoupper($info->requested_by ?? '')); ?></td>

                                        <td class="border_bottom" align="center"> <b><?php echo e($name[0]); ?></b> </td>
                                        <td class="border_bottom" align="center"> <b><?php echo e($name[1]); ?></b> </td>

                                        <td class="border" align="center"><?php echo e($info->issued_by); ?> </td>
                                        <td class="border" align="center"><?php echo e($info->received_by); ?>  </td>
                                  </tr>
                                  <?php 
                                  ...
                                  <tr>
                                    ...
                                    <td class="border" align="center" style="font-size: 10px;"><?php echo e(strtoupper($info->designated_req ?? '')); ?></td>

                                  

                                        <td class="border_bottom" align="center"> <b><?php echo e($des[0]); ?></b> </td>
                                        <td class="border_bottom" align="center"> <b><?php echo e($des[1]); ?> </b> </td>
                                        <td class="border" align="center"><?php echo e($info->issued_des); ?></td>
                                        <td class="border" align="center"><?php echo e($info->received_des); ?></td>
                                  </tr>
                                  <tr>
