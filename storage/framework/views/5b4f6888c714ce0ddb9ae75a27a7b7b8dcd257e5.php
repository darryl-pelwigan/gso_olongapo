  ...
  <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div id="status"></div>
                <div id="contents-menu">
                    <form class="form-horizontal" id="set_prop" method="post" action="<?php echo e(route('po.po_requisition_pc_pdf')); ?>">
                      <div class="box-body">
                        <div id="statusC"></div>
                          <!-- DATE RECEIVED -->
              ...
              render : function(data , type , row){
                  if(data.requisition_id){
                    return '<button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#add_requisition" onclick="$(this).updateRequisition('+data.pono_id+');" >Update RIS</button>\
                       <form method="post" action="<?php echo e(route('po.po_requisition_pdf')); ?>">\
                       <?php echo e(csrf_field()); ?>\
