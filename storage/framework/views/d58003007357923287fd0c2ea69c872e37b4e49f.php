      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-info box-shadow">
           ...
           <form class="form-horizontal" id="new_ppe_mnthly" method="POST" action="<?php echo e(route('inventory.update_ppe_pr')); ?>">
            <input type="hidden" name="pmi_id" value="<?php echo e($pmi->id); ?>">
                    <div class="form-group">
                      <label for="type_es" class="col-sm-3 control-label">TYPE OF Inventory</label>
                             <div class="col-sm-6">
                              <div class="radio">
                                <label>
                                  <input type="radio" class="set-control-number" name="type_es" id="type_es1" value="Supplies" <?php echo e($pmi->type == 'Supplies' ? "checked" : ""); ?>>
                                     SUPPLIES
                                </label>
                              </div>
                              <div class="radio">
                                <label>
                                  <input type="radio" class="set-control-number" name="type_es" id="type_es2" value="Equipement" <?php echo e($pmi->type == 'Equipement' ? "checked" : ""); ?>>
                                  EQUIPEMENT
                                </label>
                              </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control  set-control-number" id="date_log"   name="date_log"   placeholder="Date Log Y-m-d"  value="<?php echo e(old('date_log') ?  old('date_log') : $pmi->date_log); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control" id="dept" name="dept" placeholder="Department" value="<?php echo e($pmi->inv_dept->dept_desc); ?>"  readonly>
                              <input type="hidden" class="form-control" id="pr_sdept_id" name="pr_sdept_id"  value="<?php echo e($pmi->department); ?>" >
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text"  class="form-control  " id="control_no"   name="control_no"   placeholder="Control # " readonly value="<?php echo e($pmi->inv_control_no); ?>" />
                        </div>
                      </div>
                    ...
                    <input type="hidden" id="set_control_number_a" value="0">
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control " id="item_pono"   name="item_pono"   placeholder="PO Number" value="<?php echo e($po_no); ?>" <?php echo e($po_readonly); ?> />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control item_supplier"  name="item_supplier" readonly value="<?php echo e($supplier); ?>"   /><input type="hidden" class="form-control"  name="item_supplier_id"  value="<?php echo e($supplier_id); ?>"  />
                        </div>
                    </div>
                        ...
                        <div class="form-group" style="margin: 0;">
                          <table class="table table-bordered table-striped " id="ppe-mnthly-report-items-add">
                              ...
                              <tbody>
                                <?php $__currentLoopData = $pmi->inv_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                   <?php 
                                    // dd($items);
                                   ?>
                                         <tr id="tr_1"><input type="hidden" name="item_id[]" value="<?php echo e($items->id); ?>">
                                              <td><textarea   class="form-control" name="item_desc[]" readonly><?php echo e($items->item_desc); ?></textarea></td>
                                              <td><input type="text" class="form-control"  name="item_property_code[]" value="<?php echo e($items->property_code); ?>" /></td>
                                              ...
                                              <td><input type="text" class="form-control item_unit_value"  name="item_unit_value[]" style="width: 100px;" value="<?php echo e($items->unit_value); ?>" readonly /></td>
                                              <td><input type="text" class="form-control"  name="item_total_value[]" style="width: 100px;" disabled="" value="<?php echo e($items->unit_value * $items->qty); ?>" readonly /></td>
                                              <td><input type="text" class="form-control item_accountable_person"  name="item_accountable_person[]" value="<?php echo e($items->accountable ? $items->accountable->lname.','.$items->accountable->fname : ''); ?>"  /> <input type="hidden" class="form-control"  name="item_accountable_person_id[]" value="<?php echo e($items->accountable_person); ?>" /> </td>
                                              <td><input type="text" class="form-control"  name="item_invoice[]" value="<?php echo e($items->invoice); ?>" /></td>
                                          </tr>
