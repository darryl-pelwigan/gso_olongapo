                      ...
                      <td id="table_left" width="40%">
                        <table class="table_header" width="100%" >
                          <tr>
                            ...
                            <td width="80%" class="underline"><center><?php echo e($info->_main_dept_desc); ?></center></td>
                          </tr>
                          <tr>
                            <td>Office: </td>
                      ...
                      <td id="" width="40%">
                        <table class="table_header" width="100%">
                          <tr>
                            ...
                            <td width="60%" class="underline" style="text-align: center;"> <?php echo e($info->ris_no); ?> </td>
                          </tr>
                          <tr>
                            <td style="text-align: center;">SAI No.: </td>
                            <td class="underline" style="text-align: center;"><?php echo e($info->sai_no ?? ''); ?></td>
                          </tr>
                        </table>
                      </td>
                      <td id="" width="30%">
                        <table class="table_header" width="100%">
                          <tr>
                            ...
                            <td width="60%" class="underline" style="text-align: center;"><?php echo e(date('F j Y', strtotime($info->ris_date))); ?></td>
                          </tr>
                          <tr>
                            <td  style="text-align: center;">Date: </td>
                            <td class="underline" style="text-align: center;"><?php echo e(isset($info->sai_date) ?  date('F j Y', strtotime($info->sai_date)) : ''); ?></td>
                          </tr>
                        </table>
                      </td>
                      </td>
                              ...
                              <td colspan="6">
                                <table class="table1 page-break" width="100%">
                                  ...
                                  <tr>
                                    ...
                                    <?php if($request_signee): ?>
                                      <?php $__currentLoopData = $request_signee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td class="border_bottom" align="center"> <b> <?php echo e($rs->full_name ?? ''); ?></b> </td>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                  ...
                                  <tr>
                                    ...
                                    <td class="border" align="center" style="font-size: 10px;"><?php echo e(strtoupper($info->designated ?? '')); ?></td>

                                    <?php if($request_signee): ?>
                                      <?php $__currentLoopData = $request_signee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td class="border_bottom" align="center"> <b> <?php echo e($rs->position); ?></b> </td>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
