...
console.log($('#new_supplier').serialize());
 ...
 var el = $('#submit_empl');
      ...
      $.ajax({
            type: "POST",
            url: "<?php echo e(route('inv.new_suppplier')); ?>",
...
$.fn.viewSupplier  = function(supp_id){
  ...
  $.ajax({
            type: "POST",
            url: "<?php echo e(route('bac.supplier')); ?>",
            data : {
              supp_id:supp_id,
              "_token" : '<?php echo e(csrf_token()); ?>',
            },
...
$.fn.updateSupplier = function(){
    $.ajax({
            type: "POST",
            url: "<?php echo e(route('bac.update_supplier')); ?>",
            data : {
...
$.fn.deleteSupllierRecord = function(){
  ...
  if(x){
    $.ajax({
        type: "POST",
        url: "<?php echo e(route('bac.delete_supplier')); ?>",
