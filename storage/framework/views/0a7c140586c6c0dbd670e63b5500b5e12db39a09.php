                    ...
                    <tr>
                      <td id="table_left" width="50%">
                        <table class="table_header" width="100%">
                          <tr>
                            <td>Supplier: </td>
                            <td class="underline"><strong><?php echo e($info->suppl_title); ?></strong></td>
                          </tr>
                          <tr>
                            <td>Address: </td>
                            <td class="underline"><strong><?php echo e($info->details); ?></strong></td>
                          </tr>
                        </table>
                      </td>
                      <td width="50%">
                        <table class="table_header" width="100%">
                          <tr>
                            ...
                            <td width="60%" class="underline"><?php echo e($info->po_no); ?></td>
                          </tr>
                          <tr>
                            <td>Date.:</td>
                            <td class="underline"><?php echo e($info->po_date); ?></td>
                          </tr>
                          <tr>
                            <td>Mode of Procurement:  </td>
                            <td class="underline"><?php echo e($info->bac_mode); ?></td>
                          </tr>
                          <tr>
                            <td>P.R No:/s :</td>
                            <td class="underline"><?php echo e($info->pr_no); ?></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                      ...
                      <?php $count=1; $total_price=0; ?>
                        <?php $__currentLoopData = $po_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              ...
                              <td class="text-right2"><?php echo e(number_format($data->po_amount,2)); ?> </td>
                              <td class="text-right2"><?php echo e(number_format($data->po_total,2)); ?> </td>
                            </tr>
                        ...
                        ?>
                            <tr>
                             ...
                             <td class="text-right2 total"><?php echo e(number_format($total_price,2)); ?></td>
                            </tr>
                            <tr>
                              <td colspan="6">
