...
$.fn.sentNewEmployee = function(){
  $.ajax({
      type: "POST",
      url: "<?php echo e(route('emp.add_employee_creadentials')); ?>",
 ...
 $.fn.editEmployee = function(emp_id){
    ...
    $.ajax({
        type: "POST",
         url: "<?php echo e(route('emp.get_employee_credentials')); ?>",
        data : {
          emp_id : emp_id,
          _token : '<?php echo e(csrf_token()); ?>'
        },
  ...
  $.fn.setmployeeCredentials = function(){
    $.ajax({
        type: "POST",
        url: "<?php echo e(route('emp.set_employee_creadentials')); ?>",
  ...
  $.fn.deleteEmployeeRecord = function(){
    ...
    if(x){
      $.ajax({
          type: "POST",
          url: "<?php echo e(route('emp.delete_employee_record')); ?>",
