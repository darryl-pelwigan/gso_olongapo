             ...
             { data: 'obr_date', name: 'olongapo_obr.obr_date' },
              ...
              render : function(data , type , row){
                      if(data.requisition_id){
                        ...
                        <form method="post" action="<?php echo e(route('po.po_requisition_pdf')); ?>"><?php echo e(csrf_field()); ?><input type="hidden" name="requisition_id" value="'+data.requisition_id+'" /><input type="submit" class="btn btn-sm btn-default" name="pdf" value="Pdf" /> </form>  ';
                      }else{
            ...
            data: null,
              ...
              render : function(data , type , row){
                      if(data.requisition_id){
                        ...
                        <form method="post" action="<?php echo e(route('po.po_requisition_pc_pdf')); ?>"><?php echo e(csrf_field()); ?><input type="hidden" name="requisition_id" value="'+data.requisition_id+'" /><input type="submit" class="btn btn-sm btn-default" name="pdf" value="Pdf" /> </form>  ';
                      }else{
...
$.fn.addRequisition = function(pono_id){
   $("#add_requisition_number")[0].reset();
    $.ajax({
            type: "POST",
             url: "<?php echo e(route('po.get-po')); ?>",
            data : {
              pono_id : pono_id,
              _token : '<?php echo e(csrf_token()); ?>'
            },
...
$.fn.addRequisition_pc = function(prno_id){
   $("#add_requisition_number_pc")[0].reset();
    $.ajax({
            type: "POST",
             url: "<?php echo e(route('po.get-pc')); ?>",
            data : {
              pono_id : prno_id,
              _token : '<?php echo e(csrf_token()); ?>'
            },
...
$('#ris_date').on('change',function(){
    $.ajax({
            type: "POST",
            url: "<?php echo e(route('po.check_ris_no')); ?>",
            data : {
...
$('#ris_date2').on('change',function(){
  ...
  $.fn.sentRequisitionNo = function(isCnsmp){
    ...
    console.log(form);
      $.ajax({
            type: "POST",
            url: "<?php echo e(route('po.add_requisition')); ?>",
